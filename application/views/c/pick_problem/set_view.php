    ...
    <form role="form" action="<?=base_url();?>c/Problem_set/save" method="post">
        ...
        <fieldset>
            ...
            <div class="form-group required">
                ...
                <textarea id="solution_code" name="solution_code" class="form-control min-h-130 codemirror-textarea" placeholder="Tell standard code" required><?php echo  $problem_solution[0]->solution_code;?></textarea>
            </div>
