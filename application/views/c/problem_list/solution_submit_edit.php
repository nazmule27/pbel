        ...
        <div class="form-group required">
            <fieldset>
                ...
                <div class="form-group required">
                    ...
                    <textarea id="solution_code" name="solution_code" class="form-control min-h-130 codemirror-textarea" placeholder="Tell standard code" required><?php echo $single_solution[0]->solution_code; ?></textarea>
                </div>
