    ...
    <form role="form" action="<?=base_url();?>c/Problem_set/save" method="post">
        <div class="row">
            ...
            <div class="form-group col-md-6 required">
                ...
                echo form_dropdown('type', $type, '', 'id="type" class="form-control custom-text" required');
                ?>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-7">
                <div class="form-group margin0 required">
                    ...
                    <textarea name="reference_guide" class="form-control min-h-130 margin0" maxlength="255"  placeholder="Tell reference links as separate" required></textarea>
                </div>
            </div>
