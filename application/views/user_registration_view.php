		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<input class="form-control" name="full_name" placeholder="Full Name" type="text" value="<?php echo set_value('full_name'); ?>" />
				...
				<div class="form-group">
					...
					<input class="form-control" name="cpassword" placeholder="Confirm Password" type="password" autocomplete="off"/>
